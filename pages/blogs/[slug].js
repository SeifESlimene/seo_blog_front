...
const SingleBlog = ({ blog, query }) => {
  ...
  const head = () => (
    <Head>
      ...
      <link rel='cononical' href={`${DOMAIN}/blogs/${query.slug}`} />
  ...
  const showBlogTags = (blog) =>
    blog.tags.map((t, i) => (
      <Link key={i} as={`/tags/${t.slug}`} href='/tags/[slug]'>
              ...
              <section>
                <div className='row' style={{ marginTop: '-30px' }}>
                  <img
                    ...
                    alt={blog.title}
                    className='img img-fluid featured-image s-fi'
                  />
                </div>
              </section>
              <section>
                <div className='container'>
                  <h1 className='display-2 pb-3 pb-3 text-center font-weight-bold'>
                    {blog.title}
                  </h1>
